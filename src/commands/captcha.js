...
exports.run = async (client, message, args, command) => {
  ...
  const captcha = await message.channel.send({
    embeds: [new MessageEmbed()
      .setAuthor({
        name: config.serverName,
        url: `${client.user.avatar_url != null ? client.user.avatar_url : "https://media3.giphy.com/media/chiLb8yx7ZD1Pdx6CF/giphy.gif"}`
      })
