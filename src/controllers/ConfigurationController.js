...
module.exports = client => {
  client.defaultConfigBody = {
    ...
    attendancePainelChannel: "939500482790035507",
    attendancePainelMessage: "942857233421697064",
    mainServer: "939017603152740352",
    attendanceServer: "939017603152740352",
    ...
    ticketsCapacity: 50,
    staffRoles: [],
    mutedRole: "939067228870021142",
    punishChannel: "939068902556708864",
    appelChannel: null,
    reportChannel: null,
    command_roles: {
      "ajuda": ['AJUDANTE'],
